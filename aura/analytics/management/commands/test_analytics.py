...
class Command(BaseCommand):
    ...
    def test_all_events(self):
        ...
        self.stdout.write(
            ...
            (self.style.ERROR(f'Failed: {fail_count}') if fail_count > 0
    ...
    def generate_test_data(self, event_class):
        ...
        for attr in event_class.attributes:
            ...
            elif attr.name in ['success', 'has_notes', 'has_summary', 'has_attachments', 'includes_pii']:
                test_data[attr.name] = True
            elif attr.type == int:
                # For integer fields
                if 'count' in attr.name or 'minutes' in attr.name or 'seconds' in attr.name:
