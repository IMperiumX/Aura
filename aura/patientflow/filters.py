...
class AppointmentFilter(django_filters.FilterSet):
    ...
    scheduled_date_gte = django_filters.DateFilter(field_name='scheduled_time__date', lookup_expr='gte')
    scheduled_date_lte = django_filters.DateFilter(field_name='scheduled_time__date', lookup_expr='lte')
    scheduled_time_gte = django_filters.DateTimeFilter(field_name='scheduled_time', lookup_expr='gte')
    scheduled_time_lte = django_filters.DateTimeFilter(field_name='scheduled_time', lookup_expr='lte')
    ...
    has_status = django_filters.BooleanFilter(field_name='status', lookup_expr='isnull', exclude=True)

    # Provider filters
    provider = django_filters.ModelChoiceFilter(queryset=None)  # Will be set in __init__
    provider_name = django_filters.CharFilter(method='filter_provider_name')
    has_provider = django_filters.BooleanFilter(field_name='provider', lookup_expr='isnull', exclude=True)
    ...
    class Meta:
        model = Appointment
        fields = [
            'clinic', 'patient', 'provider', 'status', 'external_id'
        ]
...
class PatientFlowEventFilter(django_filters.FilterSet):
    ...
    date_gte = django_filters.DateFilter(field_name='timestamp__date', lookup_expr='gte')
    date_lte = django_filters.DateFilter(field_name='timestamp__date', lookup_expr='lte')
    ...
    patient_name = django_filters.CharFilter(method='filter_patient_name')
    clinic = django_filters.ModelChoiceFilter(field_name='appointment__clinic', queryset=Clinic.objects.all())
...
class NotificationFilter(django_filters.FilterSet):
    ...
    unread = django_filters.BooleanFilter(field_name='is_read', lookup_expr='exact', exclude=True)

    # Date filters
    sent_date = django_filters.DateFilter(field_name='sent_at__date')
    sent_date_gte = django_filters.DateFilter(field_name='sent_at__date', lookup_expr='gte')
    sent_date_lte = django_filters.DateFilter(field_name='sent_at__date', lookup_expr='lte')
    ...
    # Event filters
    event_status = django_filters.CharFilter(field_name='event__status__name', lookup_expr='icontains')
    event_clinic = django_filters.ModelChoiceFilter(field_name='event__appointment__clinic', queryset=Clinic.objects.all())
    patient_name = django_filters.CharFilter(method='filter_patient_name')
...
class PatientFilter(django_filters.FilterSet):
    ...
    created_date_gte = django_filters.DateFilter(field_name='created_at__date', lookup_expr='gte')
    created_date_lte = django_filters.DateFilter(field_name='created_at__date', lookup_expr='lte')
    ...
    appointments_today = django_filters.BooleanFilter(method='filter_appointments_today')
...
class StatusFilter(django_filters.FilterSet):
    ...
    # Usage filters
    has_appointments = django_filters.BooleanFilter(method='filter_has_appointments')
    appointment_count_gte = django_filters.NumberFilter(method='filter_appointment_count_gte')
