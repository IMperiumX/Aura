...
from aura.audit_log import AuditLogEvent
from aura.audit_log import AuditLogEventManager
from aura.audit_log import AuditLogEventNotRegistered
from aura.audit_log import DuplicateAuditLogEventError
...
class AuditLogEventManagerTest(TestCase):
    ...
    def test_duplicate_event_id(self):
        ...
        with pytest.raises(DuplicateAuditLogEventError):
            test_manager.add(
                AuditLogEvent(
                    event_id=500,
                    name="TEST_DUPLICATE",
