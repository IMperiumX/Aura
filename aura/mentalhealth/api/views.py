...
#     except Exception:
#         logger.exception("Failed to analyze session notes:")
#         return []
#     else:
#         return insights
...
#     except Exception:
#         logger.exception("Failed to calculate session effectiveness:")
...
#     except Exception:
#         logger.exception("Failed to analyze conversation sentiment:")
#         return 0.5  # Neutral
...
#     except Exception:
#         logger.exception("Failed to extract conversation topics:")
#         return []  # Neutral
...
#     except Exception:
#         logger.exception("Failed to predict user satisfaction:")
...
#     except Exception:
#         logger.exception("Failed to calculate progress trend:")
#         return "unknown"
#     else:
#         return "stable"
...
#         avg_effectiveness = sessions.aggregate(avg=models.Avg("effectiveness_score"))["avg"] or 0
#         if avg_effectiveness < 6.0:
#             recommendations.append("Review current therapeutic approach")

#     except Exception:
#         logger.exception("Failed to generate treatment recommendations:")
#         return []
#     else:
...
#                 )
#         except Exception:
#             logger.exception("Failed to record mental health throttle event:")
...
#             )
#         except Exception:
#             logger.exception("Failed to record mental health request start:")
...
#                 "db_queries": len(getattr(request, "_db_queries", [])) - request._db_queries_start,
#                 "cache_hits": getattr(request, "_cache_hits", 0) - request._cache_hits_start,
#                 "cache_misses": getattr(request, "_cache_misses", 0) - request._cache_misses_start,
#             }
...
#         except Exception:
#             logger.exception("Failed to record mental health request success:")
...
#         except Exception:
#             logger.exception("Failed to record mental health request error:")

#     def _alert_slow_request(self, request, duration, metrics):
#         """Alert on slow requests for performance monitoring."""
#         try:
#             msg = f"Slow mental health request detected: {request.path} took {duration:.2f}ms"
#             logger.warning(
#                 msg,
#                 extra={
#                     "slow_request": True,
...
#             )
#         except Exception:
#             logger.exception("Failed to alert on slow mental health request:")
...
#             )
#         except Exception:
#             logger.exception("Failed to record mental health security event:")
...
#         except Exception:
#             logger.exception("Failed to clean up request tracking:")
...
#             duration = (time.time() - start_time) * 1000
#             msg = f"Mental health database transaction completed in {duration:.2f}ms"
#             logger.debug(msg)

#         except Exception:
#             # Record failed transaction
#             duration = (time.time() - start_time) * 1000
#             msg = f"Mental health database transaction failed after {duration:.2f}ms"
...
#             if data is None:
#                 msg = f"Mental health cache miss for key: {cache_key}"
#                 logger.debug(msg)
#             else:
#                 msg = f"Mental health cache hit for key: {cache_key}"
#                 logger.debug(msg)

#         except Exception:
#             msg = f"Mental health cache get failed for key {cache_key}"
#             logger.exception(msg)
#             return None
#         else:
#             return data
...
#         except Exception:
#             msg = f"Mental health cache set failed for key {cache_key}"
#             logger.exception(msg)
#             return False
...
#                     ),
#                     "patient_id": (session.patient.id if hasattr(session, "patient") else None),
...
#         except Exception:
#             logger.exception("Failed to track status change:")

#     def _track_session_cancellation(self, session):
#         """Track session cancellation with detailed context."""
#         try:
#             notice_hours = None
#             if hasattr(session, "scheduled_at") and session.scheduled_at > timezone.now():
...
#             )
#         except Exception:
#             logger.exception("Failed to track session cancellation:")
...
#         except Exception:
#             logger.exception("Failed to track session completion:")
...
#             delay_minutes = None
#             if hasattr(session, "scheduled_at") and session.started_at > session.scheduled_at:
...
#         except Exception:
#             logger.exception("Failed to invalidate disorder caches:")
