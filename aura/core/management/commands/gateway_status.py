...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            raise CommandError(f'Gateway operation failed: {str(e)}')
        ...
        try:
            ...
            if output_format == 'json':
                ...
                if status_data['unhealthy_modules'] > 0:
                    self.stdout.write(
                        self.style.WARNING(f"Unhealthy Modules: {status_data['unhealthy_modules']}")
                    )
                self.stdout.write(f"Timestamp: {status_data['timestamp']}")
                
        except Exception as e:
            self.stdout.write(self.style.ERROR(f'Failed to get gateway status: {str(e)}'))
    ...
    def show_health_status(self, module_name, output_format):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f'Failed to get health status: {str(e)}'))
    ...
    def show_modules(self, output_format):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f'Failed to get modules: {str(e)}'))
    ...
    def show_dependencies(self, output_format):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f'Failed to get dependencies: {str(e)}'))
    ...
    def show_services(self, output_format):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f'Failed to get services: {str(e)}'))
